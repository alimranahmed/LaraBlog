...
@section('content')
    <table class="table table-hover table-bordered" id="configList">
        ...
        @foreach($configs as $config)
            <tr>
                ...
                <td class="text-center">
                    <span class="fa fa-edit text-primary pointer" v-on:click="showConfigForm({{$config}})"></span>&nbsp;
                </td>
            </tr>
        @endforeach
    </table>
...
@section('inPageJS')
    ...
    <script type="application/javascript">
        new Vue({
            ...
            data: {},
            methods: {
                showConfigForm: function (config) {
