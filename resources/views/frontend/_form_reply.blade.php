    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body row">
                <div class="col-md-12">
                    <form action="{{route('add-comment', $article->id)}}" method="post" onsubmit="return false;"
                          name="add_comment_form"
                          v-on:submit="addComment(reply)">
                        {{csrf_field()}}
                        <input type="hidden" v-model="reply.parent_comment_id" name="parent_comment_id" value="{{$comment->id}}">
